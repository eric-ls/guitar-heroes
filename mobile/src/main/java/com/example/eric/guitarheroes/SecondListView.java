 ...
 */
public class SecondListView extends ListFragment{
    ArrayList<Song> listOfFavoritedSongs = new ArrayList<>();

    @Override
    public void onCreate(Bundle onSavedInstanceState){
        super.onCreate(onSavedInstanceState);
        SongAdapter adapter = new SongAdapter(listOfFavoritedSongs);
